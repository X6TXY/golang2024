...
func ListPosts(c *fiber.Ctx) error {
	...
	if err := database.DB.Db.Preload("User").Preload("Comments").Find(&posts).Error; err != nil {
		return c.Status(fiber.StatusInternalServerError).JSON(fiber.Map{"message": "Error retrieving posts"})
	}
